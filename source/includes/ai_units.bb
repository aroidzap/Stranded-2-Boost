...
Function ai_ani(typ)
	Select typ
		...
		Case ani_idle1
			...
			If Instr(Dunit_scriptk$(TCunit\typ),"地i_idle1") Then
		...
		Case ani_idle2
			...
			If Instr(Dunit_scriptk$(TCunit\typ),"地i_idle2") Then
		...
		Case ani_idle3
			...
			If Instr(Dunit_scriptk$(TCunit\typ),"地i_idle3") Then
									...
									If g_cplayer\health#>0. Then
										...
										If checkattackline()=1 Then
											...
											If doit=1 Then
												...
												If Instr(Dunit_scriptk$(TCunit\typ),"地i_attack") Then
